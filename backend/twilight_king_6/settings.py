"""
Django settings for twilight_king_6 project.
...
ROOT_URLCONF = 'twilight_king_6.urls'
...
WSGI_APPLICATION = 'twilight_king_6.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Twilight King Support <support@twilight-king-6.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "twilight_king_6 API",
    "DESCRIPTION": "API documentation for twilight_king_6 App",
    "VERSION": "v1",
}
